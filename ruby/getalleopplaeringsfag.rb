#Author: Erlend Thune
#Email:  erlend.thune@udir.no
#Purpose: Get all curriculums from data.udir.no and write them to file.
...
request_uri = 'https://data.udir.no/kl06/v201906/opplaeringsfag.json'
request_query = ''
...
result.each do |laereplan|
  ...
  if(!laereplan['status'].eql? "https://data.udir.no/kl06/v201906/status/status_utgaatt")
    ...
    puts "Skip utgått opplæringsplan.\n"
  end
end
